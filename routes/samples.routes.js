...
router.get('/rate-card', async (_req, res) => {
  try {
    ...
    // Sample data
    const rows = [
      { client_name: 'Acme Corp', emp_code: 'EMP001', emp_name: 'Alice Johnson', doj: '2023-01-15', reporting_manager: 'Bob Smith', monthly_rate: 50000, leaves_allowed: 2 },
      { client_name: 'Acme Corp', emp_code: 'EMP002', emp_name: 'Charlie Brown', doj: '2023-03-20', reporting_manager: 'Bob Smith', monthly_rate: 60000, leaves_allowed: 1 },
      { client_name: 'Acme Corp', emp_code: 'EMP003', emp_name: 'Diana Prince', doj: '2024-06-01', reporting_manager: 'Alice Johnson', monthly_rate: 45000, leaves_allowed: 2 },
      { client_name: 'Acme Corp', emp_code: 'EMP004', emp_name: 'Edward Norton', doj: '2022-11-10', reporting_manager: 'Bob Smith', monthly_rate: 70000, leaves_allowed: 3 },
      { client_name: 'Acme Corp', emp_code: 'EMP005', emp_name: 'Fiona Apple', doj: '2024-01-05', reporting_manager: 'Alice Johnson', monthly_rate: 55000, leaves_allowed: 2 },
    ];
