...
async function seed() {
  ...
  const tables = [
    ...
    'po_consumption_log', 'purchase_orders',
    'quote_items', 'quotes',
    'attendance', 'rate_cards', 'audit_log', 'clients',
  ];
  ...
  // Rate Cards
  const rateCards = [
    { client_id: clientIds[0], emp_code: 'EMP001', emp_name: 'Arun Kumar', doj: '2024-01-15', reporting_manager: 'Vikram Singh', monthly_rate: 50000, leaves_allowed: 2 },
    { client_id: clientIds[0], emp_code: 'EMP002', emp_name: 'Sneha Reddy', doj: '2024-03-01', reporting_manager: 'Vikram Singh', monthly_rate: 65000, leaves_allowed: 2 },
    { client_id: clientIds[0], emp_code: 'EMP003', emp_name: 'Deepak Joshi', doj: '2024-06-10', reporting_manager: 'Vikram Singh', monthly_rate: 45000, leaves_allowed: 1 },
